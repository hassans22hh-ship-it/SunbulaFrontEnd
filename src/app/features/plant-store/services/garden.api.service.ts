...
import { UserPlantDto, PurchasePlantDto, GrowthHistoryDto, GardenSummaryDto } from '@shared/models/plant.models';
...
export class GardenApiService {
  ...
  getGarden(): Observable<GardenSummaryDto> { return this.http.get<GardenSummaryDto>(this.BASE); }
  ...
  grow(id: string, coins: number): Observable<UserPlantDto> { 
    return this.http.post<UserPlantDto>(`${this.BASE}/${id}/grow?coins=${coins}`, {}); 
  }
